...
void test_free_coalescing_case3(){
  ...
  PRINTF_GREEN(">>Part 5: Testing frees with coalescing. (test_free_coalescing_case3) \n");
...
void test_free_coalescing_case2(){
  ...
  PRINTF_GREEN(">>Part 5: Testing frees with coalescing. (test_free_coalescing_case2)\n");
...
void test_free_coalescing_case1(){
  ...
  PRINTF_GREEN(">>Part 5: Testing frees with coalescing. (test_free_coalescing_case1)\n");
...
void test_free_coalescing_chains_fwd(){
  ...
  PRINTF_GREEN(">>Part 5: Testing frees with coalescing chaining. (test_free_coalescing_chains_fwd) \n");
...
void test_free_coalescing_chains_bwd(){
  ...
  PRINTF_GREEN(">>Part 5: Testing frees with coalescing chaining. (test_free_coalescing_chains_bwd)\n");
